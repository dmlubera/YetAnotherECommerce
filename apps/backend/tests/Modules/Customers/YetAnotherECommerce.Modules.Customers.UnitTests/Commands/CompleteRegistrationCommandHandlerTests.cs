...
using Shouldly;
using Xunit;
using YetAnotherECommerce.Modules.Customers.Core;
...
namespace YetAnotherECommerce.Modules.Customers.UnitTests.Commands;

public class CompleteRegistrationCommandHandlerTests
{
    private readonly Mock<IUserRepository> _userRepositoryMock = new();
    private readonly Mock<ICustomersMessagePublisher> _messagePublisherMock = new();
