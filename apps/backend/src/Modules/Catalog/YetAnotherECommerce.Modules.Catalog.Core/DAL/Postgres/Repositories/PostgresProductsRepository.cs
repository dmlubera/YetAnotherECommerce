...
namespace YetAnotherECommerce.Modules.Catalog.Core.DAL.Postgres.Repositories;

internal class PostgresProductsRepository(CatalogDbContext dbContext) : IProductRepository
{
